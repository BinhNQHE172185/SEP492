...
namespace LMCM_BE.Controllers.OpenAIController
{
    ...
    public class OpenAIController : ControllerBase
    {
        ...
        public async Task<IActionResult> AnalyzeUploadFile([FromForm] AnalyzeContractRequest request)
        {
            ...
            try
            {
                ...
                var result = await _openAIService.UploadAndAnalyzeFileAsync(stream, request.File.FileName, request.Prompt);
